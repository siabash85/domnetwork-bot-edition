        ...
        <v-table fixed-header>
            <thead>
                <tr>
                    ...
                    <th class="text-right whitespace-nowrap">سطح کاربری</th>
                    <th class="text-right whitespace-nowrap">آیدی تلگرام</th>
                    <th class="text-right whitespace-nowrap">کیف پول</th>
                    <th class="text-right whitespace-nowrap">وضعیت</th>
                    <th class="text-right whitespace-nowrap">زمان ایجاد</th>
                ...
                <tr v-for="item in users" :key="item.id">
                    ...
                    <td>
                        <div class="whitespace-nowrap">
                            ...
                            <template v-else>
                                <v-chip text-color="white"> کاربر عادی </v-chip>
                            </template>
                        </div>
                    </td>
                    <td>
